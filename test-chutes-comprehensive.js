...
class ChutesAITester {
  ...
  async makeRequest(messages, model = 'qwen3-coder-480b', maxTokens = 1000) {
    try {
  ...
  async quickTest() {
    ...
    console.log('Testing with default model (qwen3-coder-480b)...')
    
    const result = await this.testModel('qwen3-coder-480b', quickScenario)
